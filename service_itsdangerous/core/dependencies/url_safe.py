...
class URLSafeSerializer(Dependency):
    """ URLSafeSerializer依赖类

    doc: https://itsdangerous.palletsprojects.com/en/2.0.x/concepts/#the-salt
    """

    name = 'URLSafeSerializer'
    ...
    def __init__(
        ...
        super(URLSafeSerializer, self).__init__(**kwargs)
    ...
    def setup(self) -> None:
        ...
        self.client = URLSafeSerializerClient(**self.serializer_options)

    def get_instance(self) -> URLSafeSerializerClient:
        """ 获取注入对象

        @return: URLSafeSerializerClient
        """
        return self.client
